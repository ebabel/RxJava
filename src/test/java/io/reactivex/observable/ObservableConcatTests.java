...
public class ObservableConcatTests {
    ...
    public void testConcatSimple() {
        ...
        List<String> values = Observable.concat(o1, o2).toList().test().values().get(0);
    ...
    public void testConcatWithObservableOfObservable() {
        ...
        List<String> values = Observable.concat(os).toList().test().values().get(0);
    ...
    public void testConcatWithIterableOfObservable() {
        ...
        List<String> values = Observable.concat(Observable.fromIterable(is)).toList().test().values().get(0);
    ...
    public void testConcatCovariance() {
        ...
        List<Media> values = Observable.concat(os).toList().test().values().get(0);
    ...
    public void testConcatCovariance3() {
        ...
        List<Media> values = Observable.concat(o1, o2).toList().test().values().get(0);
